...
BASE_DIR = "../data/experiment_data/09_03_21_Experiment_30_Labels_Test"
...
def main():
    PATH = os.path.join(BASE_DIR, SOUNDS[SOUND])
    os.chdir(PATH)
    ...
    compute_spectogram_dB(sounds[10], labels[10], True)
    compute_spectogram_dB(sounds[11], labels[11], True)
...
def compute_spectogram_dB(signal, show=False):
    ...
    if show:
        ...
        # matplotlib.pyplot.title("Spectogram of Sound {}, and label {}".format(SOUNDS[SOUND], label))
        matplotlib.pyplot.show()
